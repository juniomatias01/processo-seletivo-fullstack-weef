...
Component names should be like EventCard and not like productCard, event-card, etc. This way when we see a filename in Pascal Case, it is immediately clear that the file is a react component.
